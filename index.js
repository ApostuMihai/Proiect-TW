...
// var cssBootstrap = sass.compile(
//   __dirname + "/resurse/scss/customizare-bootstrap.scss",
//   { sourceMap: true }
// );

// fs.writeFileSync(
//   __dirname + "/resurse/css/biblioteci/bootstrap-custom.css",
//   cssBootstrap.css
// );
...
app.get(["/despre"], function (req, res) {
  res.render("pages/despre", { imagini: obGlobal.imagini });
});
